...
import { VixSidebarWidget } from "@/components/vix-sidebar-widget";
...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed top-16 left-0 z-50 h-[calc(100vh-4rem)] w-[13rem] shrink-0 overflow-y-auto border-r border-border/40 bg-background p-1.5 transition-transform duration-200
