...
export function VixGuideModal({ onClose }: { onClose: () => void }) {
      ...
      >
        ...
        >
          ...
          <section className="mb-6">
            <h3 className="mb-2 text-base font-semibold">공포지수가 뭔가요?</h3>
          ...
          {/* 2. 어떻게 계산되나요? */}
          <section className="mb-6">
            <h3 className="mb-2 text-base font-semibold">어떻게 계산되나요?</h3>
            <ul className="space-y-1.5 text-sm leading-relaxed text-muted-foreground">
              ...
              <li>
                보험을 사려는 사람이 많아지면 &rarr; 보험료(옵션 가격)가
                올라가고 &rarr; VIX도 올라갑니다.
              </li>
              <li>
          ...
          <section className="mb-6">
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-lg border border-border bg-muted/30 p-4">
                ...
                <p className="text-sm leading-relaxed text-muted-foreground">
                  시장에 뚜렷한 위험 신호가 있습니다. 투자자들이 적극적으로
                  방어 태세를 취하고 있습니다.
                </p>
              </div>
              <div className="rounded-lg border border-border bg-muted/30 p-4">
          ...
          <section className="mb-6">
            ...
            <ul className="space-y-1.5 text-sm leading-relaxed text-muted-foreground">
              <li>VIX가 낮다고 &ldquo;위험이 없다&rdquo;는 뜻은 아닙니다.</li>
              <li>
                오히려 VIX가 너무 낮으면(12 이하) &ldquo;투자자들이 너무
                안심하고 있다&rdquo;는 경고일 수 있습니다.
              </li>
              <li>
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              입니다. 체온이 높으면 몸에 이상이 있다는 신호이고, 너무 낮아도
              무감각한 상태일 수 있습니다. 정기적으로 체크하면서 시장의 건강
              상태를 확인하세요.
            </p>
          </section>
        </div>
