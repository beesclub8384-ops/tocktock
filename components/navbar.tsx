...
const navLinks = [
  ...
  { href: "/ken-fisher/korea-market", label: "켄 피셔 · 한국 시장 매력도" },
...
const pcNavItems: NavItem[] = [
  ...
  { type: "link", href: "/sectors-us", label: "미국 섹터" },
  ...
  { type: "link", href: "/superinvestor", label: "슈퍼투자자" },
  {
    ...
    items: [
      ...
      { href: "/ken-fisher/korea-market", label: "한국 시장 매력도" },
